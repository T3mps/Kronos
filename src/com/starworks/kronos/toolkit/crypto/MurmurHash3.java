...
public final class MurmurHash3 {
    ...
    public final int DEFAULT_SEED = 0x19919; // 104729;
    ...
    public int hash32(final byte[] data, final int seed) {
    ...
    public int hash32(final String data, final int seed) {
        byte[] bytes = data.getBytes(Charset.forName("UTF-8"));
        return hash32(bytes, 0, bytes.length, seed);
    }

    public long[] hash128(final byte[] data) {
        return hash128(data, 0, data.length, DEFAULT_SEED);
    }

    public long[] hash128(final byte[] data, final int seed) {
        return hash128(data, 0, data.length, seed);
    }

    public long[] hash128(final byte[] data, final int offset, final int length, final int seed) {
        long h1 = seed;
        long h2 = seed;
    ...
    public long[] hash128(final String data) {
        byte[] bytes = data.getBytes(Charset.forName("UTF-8"));
        return hash128(bytes, 0, bytes.length, DEFAULT_SEED);
    }

    public long[] hash128(final String data, final int seed) {
        byte[] bytes = data.getBytes(Charset.forName("UTF-8"));
