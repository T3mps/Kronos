 ...
 * <li>{@link #rotate(Vector2,float,Vector2)}</li>
 * <li>{@link #fft(float[])}</li>
 * <li>{@link #tripleProduct(Vector2,Vector2,Vector2)}</li>
 * <li>{@link #compare(float, float, float)}</li>
 * <li>{@link #compare(Vector2, Vector2, float)}</li>
 * <li>{@link #compare(float, float)}</li>
 * <li>{@link #compare(Vector2, Vector2)}</li>
 * </ul>
 * 
...
public class Mathf {
	...
	*/
	...
	public static Vector2 rotate(Vector2 vec, float radians, Vector2 origin) {
	...
	public static float[] fft(float[] values) {
		...
		for (int i = 0; i < n * f1_2; i++) {
			...
			float cos = (float) Mathf.cos(-2 * Mathf.PI * i / n);
